...
#add for Fota restore
if [ -f "/data/data/result" ];then
  log "install recovery image"
  sh /system/bin/install-recovery.sh
  log "restore modem parameters"
  sh /system/bin/restore.sh
